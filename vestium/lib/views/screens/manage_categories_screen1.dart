...
class _ManageCategoriesScreenState extends State<ManageCategoriesScreen> {
  ...
  void _addCategory() {
    if (_newCategoryController.text.isNotEmpty) {
      setState(() {
        categories.add(Category(name: _newCategoryController.text, itemCount: 0));
          ...
          TextButton(
            onPressed: () {
              if (controller.text.isNotEmpty) {
                setState(() {
                  categories[index] = Category(name: controller.text, itemCount: categories[index].itemCount);
                });
              }
