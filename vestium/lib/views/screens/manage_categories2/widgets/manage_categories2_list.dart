...
class ManageCategories2List extends StatelessWidget {
  const ManageCategories2List({super.key});
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              context.read<ManageCategories2Cubit>().deleteCategory(index);
              Navigator.pop(context);
            },
            child: const Text(
              'Delete',
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: BlocBuilder<ManageCategories2Cubit, ManageCategories2State>(
