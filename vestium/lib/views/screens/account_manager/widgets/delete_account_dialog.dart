      ...
      child: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                loc.accountManagerDeleteAccountDialogTitle,
              ...
              Text(
                loc.accountManagerDeleteAccountDialogDescription,
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    showDialog(
                      context: context,
                      builder: (dialogContext) => BlocProvider.value(value: cubit, child: const _FinalDeleteDialog()),
                    );
                  },
                  ...
                  child: Text(
                    loc.accountManagerDeleteAccountButton,
                    style: const TextStyle(
                      fontFamily: 'CormorantGaramond',
                      fontSize: 16,
                      fontWeight: FontWeight.w600,
      ...
      child: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                loc.accountManagerFinalConfirmation,
                style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: Color(0xFFD32F2F)),
              ),
              const SizedBox(height: 16),
              Text(
                loc.accountManagerFinalConfirmationDescription,
              ...
              Column(
                ...
                children: [
                  Text(
                    loc.accountManagerTypeDelete,
                    style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: Color(0xFF2C2C2C)),
                  ),
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: loc.accountManagerTypeDeleteHint,
                      filled: true,
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: _isDeleteCorrect && _password.text.isNotEmpty
                      ...
                      : null,
                  style: ElevatedButton.styleFrom(
                    backgroundColor: _isDeleteCorrect && _password.text.isNotEmpty
