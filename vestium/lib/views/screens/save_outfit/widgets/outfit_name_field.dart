...
//         // final outfitName = state is SaveOutfitDataLoaded ? state.outfitName : '';

//         return TextField(
//           enabled: isEnabled,
//           onChanged: (value) =>
//               context.read<SaveOutfitCubit>().updateOutfitName(value),
      ...
      children: [
        ...
        BlocBuilder<SaveOutfitCubit, SaveOutfitState>(
          builder: (context, state) {
            ...
            return TextField(
              enabled: isEnabled,
              onChanged: (value) => context.read<SaveOutfitCubit>().updateOutfitName(value),
              style: const TextStyle(
                fontFamily: 'Inter',
                fontSize: 15,
