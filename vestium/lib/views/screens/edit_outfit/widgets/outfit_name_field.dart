...
class OutfitNameField extends StatefulWidget {
  const OutfitNameField({super.key});

  @override
  State<OutfitNameField> createState() => _OutfitNameFieldState();
}

class _OutfitNameFieldState extends State<OutfitNameField> {
        ...
        BlocBuilder<EditOutfitCubit, EditOutfitState>(
          builder: (context, state) {
            ...
            return TextField(
              ...
              onChanged: (value) {
                context.read<EditOutfitCubit>().updateName(value);
              },
              style: const TextStyle(
                fontFamily: 'Inter',
                fontSize: 15,
              ...
              decoration: InputDecoration(
                hintText: loc.editOutfitNameHint,
                hintStyle: TextStyle(
                  fontFamily: 'Inter',
                  fontSize: 15,
                  fontWeight: FontWeight.w200,
