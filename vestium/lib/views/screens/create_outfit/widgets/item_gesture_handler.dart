...
class _ItemGestureHandlerState extends State<ItemGestureHandler> {
      ...
      onLongPress: () {
        showDialog(
          ...
          builder: (context) => AlertDialog(
            ...
            content: const Text('Remove this item from the outfit?'),
            actions: [
              TextButton(
              ...
              TextButton(
                onPressed: () {
                  context.read<CreateOutfitCubit>()
                      .removeItemFromOutfit(widget.placedItem.itemId);
  ...
  Offset _calculateNewPosition(Offset proposedPosition) {
    ...
    double clampedX = proposedPosition.dx.clamp(
      padding,
      widget.canvasSize.width - itemWidth - padding,
    );
    
    double clampedY = proposedPosition.dy.clamp(
      padding,
      widget.canvasSize.height - itemHeight - padding,
    );
